...
for user_id in db:
    ...
    stalker = db[user_id]["stalker"]
    headers = json.load(open("settings.json", 'r'))[stalker]
    followers = relations.followers(user_id, username, headers)
    following = relations.following(user_id, username, headers)
